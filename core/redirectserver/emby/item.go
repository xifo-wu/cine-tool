...
func GetItemPathInfo(c echo.Context) (itemInfoUri string, itemId string, etag string, mediaSourceId string, apiKey string) {
	embyHost := viper.GetString("EMBY_URL")
	embyApiKey := viper.GetString("EMBY_API_KEY")
